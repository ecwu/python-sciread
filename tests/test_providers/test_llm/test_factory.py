...
from sciread.providers.llm.factory import InvalidModelIdentifierError
from sciread.providers.llm.factory import ModelFactory
from sciread.providers.llm.factory import UnsupportedModelError
from sciread.providers.llm.factory import get_model
from sciread.providers.llm.lmstudio import LMStudioProvider
from sciread.providers.llm.ollama import OllamaProvider
from sciread.providers.llm.volcengine import VolcengineProvider
...
class TestModelFactory:
    ...
    def test_parse_model_identifier_without_provider(self):
        ...
        with patch("sciread.providers.llm.factory.get_config") as mock_config:
            mock_config.return_value.providers.llm.default.provider = "deepseek"
            mock_config.return_value.providers.llm.default.model = "deepseek-v4-flash"
    ...
    @patch("sciread.providers.llm.factory.get_config")
    ...
    def test_create_model_unsupported_model(self):
        ...
        with patch("sciread.providers.llm.factory.get_config"):
...
class TestGetModel:
    ...
    @patch("sciread.providers.llm.factory.ModelFactory.create_model")
