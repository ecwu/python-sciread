...
class TestOllamaProvider:
    ...
    @patch("sciread.providers.llm.ollama.get_config")
    def test_create_model_success(self, mock_config):
        ...
        with (
            patch("sciread.providers.llm.ollama.OpenAIChatModel") as mock_model_class,
            patch("sciread.providers.llm.ollama.PydanticOllamaProvider") as mock_provider,
        ):
