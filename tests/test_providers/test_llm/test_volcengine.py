...
class TestVolcengineProvider:
    ...
    @patch("sciread.providers.llm.volcengine.get_config")
    def test_create_model_success(self, mock_config):
        ...
        with (
            patch("sciread.providers.llm.volcengine.OpenAIChatModel") as mock_model_class,
            patch("sciread.providers.llm.volcengine.PydanticOpenAIProvider") as mock_provider,
        ):
