...
from sciread.providers.llm import ModelFactory
...
class TestIntegration:
    ...
    def test_deepseek_end_to_end(self):
        ...
        with (
            patch("sciread.providers.llm.deepseek.get_config") as mock_config,
            patch("sciread.providers.llm.deepseek.PydanticDeepSeekProvider") as mock_provider,
            patch("sciread.providers.llm.deepseek.OpenAIChatModel") as mock_openai,
        ):
            # Mock config
...
"""
        ...
        with patch("sciread.providers.llm.factory.get_config") as mock_get_config:
