...
class TestLMStudioProvider:
    ...
    @patch("sciread.providers.llm.lmstudio.get_config")
    def test_create_model_success(self, mock_config):
        ...
        with (
            patch("sciread.providers.llm.lmstudio.OpenAIChatModel") as mock_model_class,
            patch("sciread.providers.llm.lmstudio.PydanticOpenAIProvider") as mock_provider,
        ):
    ...
    def test_create_model_defaults_to_local_settings(self, mock_config):
        ...
        with (
            patch("sciread.providers.llm.lmstudio.OpenAIChatModel"),
            patch("sciread.providers.llm.lmstudio.PydanticOpenAIProvider") as mock_provider,
        ):
