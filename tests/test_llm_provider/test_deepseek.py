...
class TestDeepSeekProvider:
    ...
    def test_create_model_success(self, mock_config):
        ...
        with (
            patch("sciread.llm_provider.deepseek.OpenAIChatModel") as mock_model_class,
            ...
            mock_model_class.assert_called_once_with(model_name="deepseek-v4-flash", provider=mock_provider_instance)
    ...
    def test_create_model_with_custom_base_url(self, mock_config):
        ...
        with (
            ...
            # Verify the model was created with correct parameters
            mock_model_class.assert_called_once_with(model_name="deepseek-v4-flash", provider=mock_provider.return_value, temperature=0.7)
